...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <form id="myform">
            ...
            <input placeholder="Dirección" type="text" name="direccion" id="direccion" required>

            <input placeholder="Ciudad" type="text" name="ciudad" id="ciudad" required>

            <input placeholder="ejemplo@correo.com" type="email" name="email" id="email" required>

            <input placeholder="Teléfono" type="text" name="telefono" id="telefono" required>

            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <input type="hidden" name="id_roles" value="1">
            <input type="hidden" name="contrasena" value="0">
    ...
    <script>
        ...
        function submitForm(e) {
            ...
            .then((res) => {
                ...
                fetch('/PHPprojects/ecommerce/public/carrito', {
                    method: 'POST',
                    headers: {
